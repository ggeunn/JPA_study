...
public class GroupRepository {
    ...
    public long countMenuOfCategory(int categoryCode) {
        ...
        String jpql = "SELECT count(m) FROM section03Menu m WHERE m.categoryCode = :categoryCode";
    ...
    public Long noResult(int categoryCode) {
        ...
        String jpql = "SELECT SUM(m.menuPrice) FROM section03Menu m WHERE m.categoryCode = :categoryCode";
